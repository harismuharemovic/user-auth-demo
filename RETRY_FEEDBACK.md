...
**Timestamp:** 2025-10-08 14:03:59 UTC
...
✅ TC-001
   Inputs: 10, 2, 5
   Expected: 10
   Test: divideAndAdd - TC-001 should return 10 when inputs are (10, 2, 5)

✅ TC-002
   Inputs: 20, 4, 3
   Expected: 8
   Test: divideAndAdd - TC-002 should return 8 when inputs are (20, 4, 3)

✅ TC-003
   Inputs: 15, 3, 0
   Expected: 5
   Test: divideAndAdd - TC-003 should return 5 when inputs are (15, 3, 0)

❌ TC-004
   Inputs: 0, 1, 10
   Expected: Error: Cannot divide by zero
   Test: divideAndAdd - TC-004 should throw "Cannot divide by zero" error when inputs are (0, 1, 10)
   Error: AssertionError: expected [Function] to throw an error
    at Proxy.<anonymous> (file:///home/runner/work/user-auth-demo/user-auth-demo/node_modules/@vitest/expect/dist/index.js:1420:16)
    at Proxy.<anonymous> (file:///home/runner/work/user-auth-demo/user-auth-demo/node_modules/@vitest/expect/dist/index.js:1029:14)
    at Proxy.methodWrapper (file:///home/runner/work/user-auth-demo/user-auth-demo/node_modules/chai/chai.js:1706:25)
    at /home/runner/work/user-auth-demo/user-auth-demo/tests/divideAndAdd.test.ts:43:8
